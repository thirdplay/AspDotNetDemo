...
namespace Prototype.Mvc.Html
{
    ...
    public static class DropDownListExtensions
    {
        ...
        /// <summary>
        /// 指定された式で表されるオブジェクトの各プロパティについて、指定されたリスト項目、オプション ラベル、および HTML 属性を使用して HTML select 要素を返します。
        /// </summary>
        /// <typeparam name="TModel">モデルの型</typeparam>
        /// <typeparam name="TProperty">プロパティの型</typeparam>
        /// <param name="htmlHelper">このメソッドによって拡張される HTML ヘルパー インスタンス</param>
        ...
        {
            return htmlHelper.DropDownListFor(expression, null, optionLabel, htmlAttributes);
        }
    }
}