...
{
    /// <summary>
    /// プロパティで許容される最小値を指定します。
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    public class MinValueAttribute : ValidationBaseAttribute
    {
        /// <summary>
        /// 許容される最小値を取得します。
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">許容される最小値</param>
        public MinValueAttribute(int value) : base("MS011")
        {
            this.Value = value;
        }
        ...
        /// <returns>許容される最小値を説明する文字列</returns>
